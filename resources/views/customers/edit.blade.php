    ...
    <form action="{{route('customer.update', $customer->id)}}" method="post">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="date" name="check_in" id="check_in" class="form-control" value="{{$customer->check_in}}">
            </div>
            <div class="form-group">
                <label for="country">Check Out</label>
                <input type="date" name="check_out" id="check_out" class="form-control" value="{{$customer->check_out}}">
            </div>
            <div class="form-group">
                <label for="country">Total Harga</label>
                <input type="number" name="total_price" id="total_price" class="form-control" value="{{$customer->total_price}}">
            </div>
